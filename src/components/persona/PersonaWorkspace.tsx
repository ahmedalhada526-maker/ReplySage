...
export function PersonaWorkspace() {
  ...
  const handleExportStory = async () => {
    ...
    try {
      await exportElementAsStory(storyRef.current, `replysage-${caseId || "story"}.png`);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1
                ...
                suppressHydrationWarning
              >
                ReplySage — Your AI Reply Coach to Decode Intent & Craft Responses
              </h1>
                ...
                {!result ? (
                  ...
                  >
                    ...
                    >
                      {hydrated
                        ? t("hero_description")
                        : "Paste any message you received — a text, a chat thread, or a screenshot — and ReplySage writes the perfect reply for you in seconds."}
                    </p>
