...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "مولّد الردود الذكية — اكتب الرد المثالي على أي رسالة | PersonaPulse AI" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "مولّد الردود الذكية — اكتب الرد المثالي على أي رسالة" },
      {
      ...
      { name: "twitter:title", content: "مولّد الردود الذكية — اكتب الرد المثالي على أي رسالة" },
      {
